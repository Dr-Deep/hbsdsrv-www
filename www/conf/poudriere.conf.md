...
FREEBSD_HOST=file://${ZROOTFS}/sets
...
BASEFS=/usr/local/poudriere/base
...
TMPFS_BLACKLIST="rust* llvm* gcc* firefox* electron* vscode* nerd-fonts*"
...
GIT_BASEURL=git.hardenedbsd.org/HardenedBSD.git
...
GIT_PORTSURL=git.hardenedbsd.org/hardenedbsd/ports.git
...
ALLOW_MAKE_JOBS_PACKAGES="libreoffice* pkg chromium* iridium* ocaml-camomile* electron* qt* llvm* rust* gcc* node* vscode* electron* nerd-fonts*"
...
NOHANG_TIME=57600
MAX_EXECUTION_TIME_PACKAGE=57600 # nerd-fonts
...
BUILDER_HOSTNAME=hbsdsrv-builder
...
URL_BASE=https://hbsdsrv.1337.cx/poudriere
...
PACKAGE_FETCH_URL=https://pkg.hardenedbsd.org/HardenedBSD/pkg/\${ABI}
...
JAIL_PARAMS="hardening.pax.aslr.status=1 hardening.pax.pageexec.status=1 hardening.pax.mprotect.status=1 hardening.pax.disallow_map32bit.status=1 hardening.pax.segvguard.status=1 allow.unprivileged_proc_debug=1 allow.extattr=1 sysvmsg=new sysvsem=new sysvshm=new hardening.harden_rtld=0 hardening.harden_shm=1 allow.mlock"
